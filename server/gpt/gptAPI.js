...
async function main() {
  const chatCompletion = await openai.chat.completions.create({
    messages: [
      ...
      { role: 'user', content: 'Hola, me lamo Chris' }],
    model: 'gpt-3.5-turbo',
    temperature: 0,
  });
